...
```
cd existing_repo
git remote add origin https://git.uibk.ac.at/informatik/qe/swapsws22/group6/g6t3.git
git branch -M main
...
- [ ] [Set up project integrations](https://git.uibk.ac.at/informatik/qe/swapsws22/group6/g6t3/-/settings/integrations)
